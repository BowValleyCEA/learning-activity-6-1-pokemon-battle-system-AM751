...
//            {
//                //Player's Turn:
//                Console.WriteLine($"Its {player} turn to attack the Enemy or get Loaded yourself...");
...
//                if (enemyChoice == "N")
//                {
//                    enemyBeat -= playerHealth;
//                    Console.WriteLine($"The Player got a bit Hurt itseems {playerHealth}");
//                }
...
//                }
//                return;//The game will come to an end if one of the player wins.
//            }
//        }
//    }
